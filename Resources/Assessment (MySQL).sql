drop schema if exists OmegaDB;

CREATE DATABASE OmegaDB;
...
CONSTRAINT Employees_FK2 FOREIGN KEY (Department_No) REFERENCES Departments(Department_No));
...
Job_ID varchar(10) Not Null,
Department_No int Not Null,
Constraint Job_History_PK PRIMARY KEY (Employee_No, Start_Date),
CONSTRAINT Job_History_FK FOREIGN KEY (Employee_No) REFERENCES Employees(Employee_No));
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (126,'Fiona','Kelso','FKELSO','345 222 266','1997-07-3','ST_CLERK',8200,Null,160,190);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (130,'Adrian','Marsh','AMARSH','555 555 511','1988-03-1','CO_CHAIR',150000,Null,Null,90);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (135,'John','Lugini','JLUGINI','345 222 192','1996-05-4','ST_CLERK',7800,Null,160,190); 
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (139,'Kelly','Wight','KWIGHT','345 222 335','1999-02-2','ST_CLERK',7500,Null,160,190);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (142,'Joanna','Neilson','JNEILSON','444 232 115','1998-03-24','SA_REP',7000,0.1,150,60);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (143,'Joshua','Bitton','JBITTON','444 232 129','1999-02-6','SA_REP',8400,0.15,150,60);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (145,'Jayne','Berry','JBERRY','444 232 120','1998-05-29','SA_REP',10200,0.3,150,60);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (146,'Everton','Miles','EMILES','444 232 130','1999-05-29','SA_REP',9100,0.2,150,60);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (147,'Colin','Weston','CWESTON','444 232 132','1999-07-5','SA_REP',12000,0.3,150,60);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (149,'Roberto','Mace','RMACE','111 987 124','1996-02-6','IT_PROG',22000,Null,107,50);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (154,'Patrick','Connor','PCONNOR','444 232 138','1997-11-8','SA_REP',8900,0.2,150,60);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (155,'Peter','Court','PCOURT','111 987 130','1989-01-4','IT_PROG',17950,Null,107,50);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (160,'Trevor','Mills','TMILLS','345 222 255','1986-01-1','ST_MGR',11000,Null,160,190);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (169,'Michelle','Caprice','MCAPRICE','444 232 142','1997-04-16','SA_REP',7100,0.1,150,60);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (170,'Jackie','Matthews','JMATTHEWS','111 987 120','1997-08-5','IT_PROG',24000,Null,107,50);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (174,'Justin','Monroe','JMONROE','111 987 126','1990-04-2','IT_PROG',17500,Null,107,50);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (175,'Jose','Martinez','JMARTINEZ','111 987 134','1997-11-6','IT_PROG',16000,Null,107,50);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (177,'Kelvin','Betteridge','KBETTERIDGE','111 987 136','1998-12-5','IT_PROG',17500,Null,107,50);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (180,'Germaine','Nicholls','GNICHOLLS','665 239 155','1999-12-7','AD_CLERK',6500,Null,200,20);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (185,'Ben','Nolan','BNOLAN','444 232 125','1998-10-1','SA_REP',9500,0.2,150,60);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (204,'Gregory','Lambert','GLAMBERT','888 666 250','1992-01-5','FN_CLERK',10200,Null,125,80);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (206,'Edward','Laslo','ELASLO','333 111 435','1987-12-9','SH_CLERK',11800,Null,250,70);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (210,'Stuart','Macffrey','SMACFFREY','345 222 220','1989-05-3','ST_CLERK',9800,Null,160,190);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (222,'Peter','Bown','PBOWN','111 987 777','1997-05-5','IT_PROG',19000,Null,107,50);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (236,'William','Avery','WAVERY','444 232 135','1994-01-31','SA_REP',9000,0.2,150,60);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (245,'Gillian','Barnes','GBARNES','444 232 215','1992-09-3','SA_REP',9800,0.25,150,60);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (246,'Janet','Reismaster','JREISMASTER','444 232 220','1989-10-8','SA_REP',10500,0.25,150,60);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (250,'Tony','Luigi','TLUIGI','333 111 120','1985-12-2','SH_MGR',25000,Null,250,70);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (255,'Tracey','Hart','THART','444 232 200','1990-05-14','SA_REP',12000,0.3,150,60);
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (260,'Jessica','Flowers','JFLOWERS','555 324 120','1992-02-6','MK_REP',10500,Null,100,10);
...
Insert Into Employees (Employee_No, First_Name, Last_Name, Email, Phone_Number, Hire_Date, Job_ID, Annual_Salary, Commission_Percent, Manager_ID, Department_No) Values (274,'Ian','Holland','IHOLLAND','888 666 260','1991-06-6','FN_CLERK',8500,Null,125,80);
...
Insert Into Job_History (Employee_No, Start_Date, End_Date, Job_ID, Department_No) Values (102,'1992-06-2','1996-07-15','FN_MGR',80);
Insert Into Job_History (Employee_No, Start_Date, End_Date, Job_ID, Department_No) Values (107,'1993-03-13','1999-01-29','IT-PROG',50); 
Insert Into Job_History (Employee_No, Start_Date, End_Date, Job_ID, Department_No) Values (110,'1996-05-12','1998-12-6','FN_CLERK',80);
...
Insert Into Job_History (Employee_No, Start_Date, End_Date, Job_ID, Department_No) Values (130,'1988-03-1','1996-12-4','FN_MGR',80);
Insert Into Job_History (Employee_No, Start_Date, End_Date, Job_ID, Department_No) Values (130,'1996-12-4','1999-06-23','CO_DIR',90);
Insert Into Job_History (Employee_No, Start_Date, End_Date, Job_ID, Department_No) Values (150,'1998-03-16','1998-01-25','SA_REP',60);
Insert Into Job_History (Employee_No, Start_Date, End_Date, Job_ID, Department_No) Values (160,'1986-01-1','1993-03-25','ST_CLERK',190);
...
Insert Into Job_History (Employee_No, Start_Date, End_Date, Job_ID, Department_No) Values (250,'1985-12-2','1990-01-29','SH_CLERK',70);
